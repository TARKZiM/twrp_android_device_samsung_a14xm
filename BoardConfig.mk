...
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 loop.max_part=7 firmware_class.path=/vendor/firmware,/vendor/firmware_mnt/image
BOARD_KERNEL_PAGESIZE := 4096
BOARD_KERNEL_OFFSET := 0x00008000
BOARD_RAMDISK_OFFSET := 0x11088000
BOARD_KERNEL_TAGS_OFFSET := 0x07c08000
BOARD_BOOT_HEADER_NAME := SRPVH12A012
...
TW_LOAD_VENDOR_MODULES := "sec.ko sec_cmd.ko tp_notifier.ko focaltech_tp.ko hxchipset.ko ILI7807S_tp.ko"
...
# Crypto
PLATFORM_SECURITY_PATCH := 2028-12-31
VENDOR_SECURITY_PATCH := 2028-12-31
TW_FRAMERATE := 90
